const CerificatedGeneratedTemplate = (name) => {
	return `<!DOCTYPE html>
	<html>
	...
	<body>
		<div class="container">
            ...
            <p>Congratulations your certificate has been <span style="font-size: 20px;font-weight: bold;">Generated</span></p>
			</div>
...
module.exports = CerificatedGeneratedTemplate;