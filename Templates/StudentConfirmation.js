const StudentConfirmationTemplate = (name, AccountNumber) => {
	return `<!DOCTYPE html>
	<html>
	...
	<body>
		<div class="container">
            ...
            <p>You have Successfully created your <span style="font-size: 40px;font-weight: bold;">Account</span></p>
			</div>
			...
			<p style="font-size: 30px;">Name: <span style="color: #ef5b5b;">${name}</span></p>
            ...
            <p>-> Your account has been created on the blockchain platform to securely manage your certification journey.</p>
            <p>-> Safely store your certificates in the IPFS locker for convenient access and retrieval whenever necessary.</p>
           </div>
...
module.exports = StudentConfirmationTemplate;